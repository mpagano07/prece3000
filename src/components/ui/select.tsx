...
const SelectLabelContext = React.createContext<((value: any) => React.ReactNode) | null>(null)
...
function SelectValue({
  ...
  const resolved = children ?? (getLabel ? (value: string | null) => getLabel(value) : undefined)
  return (
